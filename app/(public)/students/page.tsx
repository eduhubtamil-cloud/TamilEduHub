...
export const metadata = {
  title: 'School Education Resources - TamilEduHub',
  description: 'Download textbooks, study materials, notes, and question papers for Classes 1 to 12.',
}
    ...
    <div className="bg-slate-50 min-h-screen py-12">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="mb-10 text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">School Education Resources</h1>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Classes 1 to 12 study materials, notes, guides, and question papers.
          </p>
        </div>
