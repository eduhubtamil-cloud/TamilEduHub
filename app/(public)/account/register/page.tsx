...
export default async function RegisterPage({
  ...
  return (
    <div className="container mx-auto flex min-h-[calc(100vh-16rem)] w-full flex-col items-center justify-center px-4 py-8">
      <Card className="w-full max-w-md shadow-sm border-slate-200">
        ...
        <CardContent className="space-y-4">
          ...
          <form action={signup} className="space-y-4">
            ...
            <Button className="w-full bg-blue-600 hover:bg-blue-700 shadow-sm" type="submit">{dict.register}</Button>
          </form>
